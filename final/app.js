...
//Display  Category Button funcion

function btnCategory() {
  // add category Dainamically
  let uniqBtn = menu.reduce((values, value) => {
  ...
  let categoryBtn = uniqBtn.map((category) => {
  ...
  //display categorywise Item
  let btns = filterBtns.forEach((btn) => {
